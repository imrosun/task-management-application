        ...
        <div className="flex flex-col border-[1px] border-[#CECECE] rounded-lg p-10 bg-[#f5f5f5] ">
          <form onSubmit={handleSubmit}>
            ...
            <div className='mb-4 text-[#999999] text-sm'>
              <input type="name" id="fullName" placeholder="Full name" value={fullName} onChange={handleFullNameChange}
            ...
            <h2 className="mt-4 text-[#606060] text-center text-sm">Already have an account? <Link href="/signin" className="text-[#0054A1]">Log in.</Link> </h2>
          </form>
        </div> 
      </div>
    </div>
